...
## 3-body dynamics and Heggie's law
...
{% include citation.html key="Xin2025a" %}
<figure class="research-figure">
...
In the summer of 2024, I worked with [Dr A Mummery](https://www.ias.edu/scholars/andrew-mummery) under a summer internship at Oxford Theoretical Physics. We developed a general, analytic framework for computing the local tidal tensor along a time-like geodesic in any stationary, axisymmetric spacetime.

{% include citation.html key="Xin2025" %}
<figure class="research-figure">
